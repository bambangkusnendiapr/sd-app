@section('title', 'Tambah Data Sholat Dhuha')
  ...
  <div>
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <h1 class="d-inline">Tambah Data Sholat Dhuha</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Admin</a></li>
              <li class="breadcrumb-item"><a href="{{ route('dhuha') }}">Data Sholat Dhuha</a></li>
              <li class="breadcrumb-item active">Tambah Data Sholat Dhuha</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <form action="{{ route('dhuha.store') }}" method="POST">
            @csrf
              <!-- Default box -->
              <!-- Akun -->
              <div class="card">
