@section('title', 'Data Sholat Fardhu')
...
<div>
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Data Sholat Fardhu</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Admin</a></li>
            <li class="breadcrumb-item active">Data Sholat Fardhu</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
                <a href="{{ route('fardhu.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Data</a>
            ...
            <div class="card-body">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <div class="input-group input-group-xl">
                            <input wire:model="search" type="text" class="form-control" placeholder="Cari Sholat...">
              ...
              <div class="table-responsive-sm">
                <table class="table table-sm table-striped mt-1">
                    ...
                    <tbody>
                      @forelse ($fardhu as $key => $data)
                        <tr class="text-center">
                            <td>{{ $fardhu->firstItem() + $key }}</td>
                            <td>{{ $data->tanggal }}</td>
                            <td>{{ $data->sholat }}</td>
                            <td>{{ $data->ket }}</td>
                            <td>
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <a href="{{ route('fardhu.edit', $data->id) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
