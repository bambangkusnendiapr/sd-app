@section('title', 'Data Sholat Dhuha')
        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
                <a href="{{ route('dhuha.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Data</a>
            ...
            <div class="card-body">
              ...
              <div class="table-responsive-sm">
                <table class="table table-sm table-striped mt-1">
                    ...
                    <tbody>
                      @forelse ($dhuha as $key => $data)
                        <tr class="text-center">
                            <td>{{ $dhuha->firstItem() + $key }}</td>
                            <td>{{ $data->tanggal }}</td>
                            <td>{{ $data->ket }}</td>
                            <td>
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <a href="{{ route('dhuha.edit', $data->id) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
