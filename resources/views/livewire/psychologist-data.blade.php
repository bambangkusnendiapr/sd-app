        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <button wire:click.prevent="addNew" type="button" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Psikolog</button>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header {{ $form == 'tambah' ? 'bg-primary':'bg-warning' }}">
          <h4 class="modal-title">{{ $form == 'tambah' ? 'Tambah':'Edit' }} Psikolog</h4>
        ...
        @endif
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <select wire:model.defer="state.nama" required class="form-control @error('nama') is-invalid @enderror" id="nama">
